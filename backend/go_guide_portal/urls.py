...
urlpatterns = [
    ...
    path("dashboard/appointments/create/", views.appointment_create, name="appointment_create"),
    path("dashboard/appointments/<int:pk>/update/", views.appointment_update, name="appointment_update"),
    path("dashboard/appointments/<int:pk>/delete/", views.appointment_delete, name="appointment_delete"),
    path("dashboard/appointments/export/", views.appointments_export_csv, name="appointments_export"),
